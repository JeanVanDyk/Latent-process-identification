...
* Save automatically .npz from amass into .pt files that can be loaded and directly used for by the denoising auto encoder.
* Use and train a DAE for for implementing missing coordinates in pointcloud.
